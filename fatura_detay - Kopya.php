...
if ($modal_mode) {
    // Modal içeriği
    ?>
    <div id="printableArea" class="bg-white rounded-lg p-4">
        <div class="print-header flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold"><?= $faturaTuruBaslik ?> #<?= htmlspecialchars($faturaNo) ?></h2>
            <div class="text-sm text-gray-500 print-date">
            ...
            <table class="min-w-full bg-white">
                <thead>
                    <tr class="bg-gray-50 border-b">
                        ...
                        <th class="py-2 px-3 text-right text-xs font-medium text-gray-500 uppercase">Net Tutar</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
        ...
        <!-- Alt bilgi -->
        <div class="mt-8 text-center text-xs text-gray-500 print-only">
            <p>Bu bir resmi fatura değildir. Bilgi amaçlı oluşturulmuştur.</p>
        </div>
    </div>
    <?php
    exit;
